...
import type { ChartDataItem, ChartDataPoint } from "../types";
...
export const prepareIncomeLineChartData = (data: ChartDataItem[] = []): ChartDataPoint[] => {
    // Group data by date
    const groupedByDate = data.reduce<Record<string, ChartDataPoint>>((acc, item) => {
